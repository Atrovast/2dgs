...
sys.path.append("/ssd/qys/Project/LE-Gaussian")
sys.path.append("/ssd/qys/Project/LE-Gaussian/ext")
sys.path.append("/ssd/qys/Project/LE-Gaussian/ext/GroundingDINO")
...
config_file = "/ssd/qys/Project/LE-Gaussian/ext/"+"GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py"
ckpt_repo_id = "ShilongLiu/GroundingDINO"
ckpt_filenmae = "groundingdino_swint_ogc.pth"
sam_checkpoint = '/ssd/qys/Project/LE-Gaussian/sam_vit_h_4b8939.pth' 
